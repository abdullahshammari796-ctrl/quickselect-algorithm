...
## 🔗 Live Demo
[View the tool on GitHub Pages](https://yourusername.github.io/quickselect-algorithm/)
...
## 📂 Files
- `index.html` — The complete self-contained tool (HTML + CSS + JS in one file)

## 🚀 How to Run
Simply open `index.html` in any modern browser, or visit the GitHub Pages link above.
